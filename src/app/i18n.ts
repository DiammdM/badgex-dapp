...
export const builderContent = {
  en: {
    ...
    afterSaveTitle: "What happens after save",
    afterSaveSteps: [
      "1. Generate PNG and upload to IPFS",
  ...
  zh: {
    ...
    afterSaveTitle: "保存后流程",
    afterSaveSteps: [
      "1. 生成 PNG 并上传 IPFS",
      "2. 生成 metadata JSON 并上传",
      "3. 将 tokenURI 保存到徽章列表",
    ],
...
export const badgesContent = {
  en: {
    ...
    filters: {
      ...
      theme: "Filter: All themes",
      shape: "Filter: All shapes",
      icon: "Filter: All icons",
    },
