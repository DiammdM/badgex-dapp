...
export const builderContent = {
  en: {
    ...
    icons: ["Star", "Bolt", "Leaf", "Flame", "Sun"],
...
export const myBadgesContent = {
  en: {
    ...
    walletStats: [
      { label: "Account", value: "0xA91...B32" },
      { label: "Minted", value: "5" },
      { label: "Listed", value: "2" },
    ],
    pipelineStats: [
      { label: "Drafts", value: "2", note: "Local only" },
      { label: "Saved", value: "2", note: "Ready to mint" },
      { label: "Minted", value: "2", note: "On-chain" },
    ],
    tokenNote: "Confirm tokenURI is ready before minting.",
    libraryTitle: "Badge Library",
    filters: ["All", "Draft", "Saved", "Minted", "Listed"],
    statusLabels: {
      draft: "draft",
      saved: "saved",
      minted: "minted",
  ...
  zh: {
    ...
    walletSnapshot: "钱包概览",
    walletStats: [
      { label: "账户", value: "0xA91...B32" },
      { label: "已铸造", value: "5" },
      { label: "已上架", value: "2" },
    ],
    pipelineStats: [
      { label: "草稿", value: "2", note: "仅本地" },
      { label: "已保存", value: "2", note: "可铸造" },
      { label: "已铸造", value: "2", note: "链上" },
    ],
    tokenNote: "铸造前确认 tokenURI 已就绪。",
    libraryTitle: "徽章库",
    filters: ["全部", "草稿", "已保存", "已铸造", "已上架"],
    statusLabels: {
      draft: "草稿",
      saved: "已保存",
      minted: "已铸造",
