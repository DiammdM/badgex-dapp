  ...
  return (
    <div className="flex flex-col gap-4 rounded-[24px] border border-slate-900/10 bg-white p-5 shadow-sm border-bright">
      ...
      <div className="flex flex-wrap gap-3">
        <button
          className="flex-1 rounded-full border border-slate-900/10 bg-slate-900 px-4 py-2 text-xs font-semibold 
          text-amber-50 shadow-sm shadow-slate-900/20 transition hover:-translate-y-0.5 hover:bg-slate-800 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-60 
          dark:border-cyan-300/30 dark:bg-cyan-500/10 dark:text-cyan-100 dark:shadow-[0_0_12px_rgba(34,211,238,0.3)] dark:hover:bg-cyan-500/20 
          dark:hover:shadow-[0_0_18px_rgba(34,211,238,0.45)]"
